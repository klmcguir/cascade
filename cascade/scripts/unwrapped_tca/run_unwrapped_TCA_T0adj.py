...
def run_unwrapped_tca(thresh=4, force=False, verbose=False):
    ...
    # --------------------------------------------------------------------------------------------------
    data_dict = {
        f'v{thresh}_on': on_mega_tensor_flat,
        f'v{thresh}_off': off_mega_tensor_flat,
        f'v{thresh}_norm_on': on_mega_tensor_flat_norm,
        f'v{thresh}_norm_off': off_mega_tensor_flat_norm,
        f'v{thresh}_speed_on': on_mega_tensor_flat_run,
        f'v{thresh}_speed_off': off_mega_tensor_flat_run,
        f'v{thresh}_speed_norm_on': on_mega_tensor_flat_run_norm,
        f'v{thresh}_speed_norm_off': off_mega_tensor_flat_run_norm
    }
    ensemble = {}
