"""Walk anastasia directories for deep POR imaging rename all dirs and files for PD naming"""
import os
...
old_name = ['OA26', 'OA27', 'OA67', 'CC175', 'VF226']
re_name = ['PD26', 'PD27', 'PD67', 'PD175', 'PD226']
