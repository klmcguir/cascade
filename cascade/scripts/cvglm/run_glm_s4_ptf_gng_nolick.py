...
def main(version='_v2_avg', loss_type='poisson', activation='exp', force=False, verbose=False, test=False):
    ...
    if test:
        ...
        glm_tag = f'_test_{loss_type}_{activation}_gng_nol_{dt_string}'
    else:
        glm_tag = f'_{loss_type}_{activation}_gng_nol'
    ...
    for meta in meta_list:
        ...
        design_df.drop(columns=['post_licks', 'anticipatory_licks'], inplace=True)
