...
def barplots_group_summary_from_meta(meta, staging='parsed_10stage', save_folder='', sharey='row'):
    ...
    if 'parsed_stage' in staging:
        assert 'parsed_stage' in meta.columns
    elif 'parsed_10stage' in staging:
        assert 'parsed_10stage' in meta.columns
    ...
    if 'parsed_10stage' in staging:
        stage_order = []
        for s in stages:
            stage_order.append(f'early {s}')
            stage_order.append(f'late {s}')
    else:
        stage_order = stages
